...
shinyUI(fluidPage(
        ...
        sidebarLayout(
                ...
                mainPanel(
                        ...
                        br(),
                        h2("Features"),
                        "* Build userful web applications with only a few lines of code --
                         no JavaScript required.",
                        br(),
                        "* Shiny applications are automatically \"live\" in the same way that ",
                        strong("spreadsheets "),
                        "are live. Outputs change intantly as users modify inputs, without requiring
                        a reload of the browser."
                        )
                )
        )
))